...
import GridItem from '@/components/GridItem.vue';
    export default {
        ...
        data() {
            return {
                items: [
                    {title: "Калькулятор дома", desc: "", backgroundImage: "house/GridItemBg.jpg", href: 'HouseCalc'},
                    {title: "Калькулятор домопух", desc: "", backgroundImage: "weapon/GridItemBg.png", href: 'WeaponCalc'},
